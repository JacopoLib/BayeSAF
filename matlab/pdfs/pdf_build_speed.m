...
%
% Description:
% pdf_build_speed constructs vectorized function handles for the prior,
% likelihood, and posterior distributions used by the DE-MC sampler. All
% three functions accept batches of MCMC samples (X_all, N_all, Eta_all)
% and return column vectors of log-probability values.
%
% Inputs:
...
function [prior, likelihood, posterior] = pdf_build_speed(...
...
for i = 1:numel(fullData)
    ...
    likelihood_handles{i} = @(X_all, N_all, Eta_all) LikelihoodFunction_speed(...

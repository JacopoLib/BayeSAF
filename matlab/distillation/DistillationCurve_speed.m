...
%
% Description:
% DistillationCurve_speed computes distillation curves for a
% batch of surrogate mixture samples in parallel using parfor. 
% Each sample calls DistillationCurve independently.
%
% Inputs:
...
function [volumeFraction_all, T_distillation_all] = DistillationCurve_speed(X_all, classes, index_n_eta_all, pressure)
...
parfor s = 1:nSamples
    ...
    [vfrac, Tcurve] = DistillationCurve(X, classes, idx_eta, pressure);

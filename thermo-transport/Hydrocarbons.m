...
species = struct('nC', num2cell(zeros(1, struct_size)), 'eta_B_star_norm', num2cell(zeros(1, struct_size)), 'molWeight', num2cell(zeros(1, struct_size)), 'Tc', num2cell(zeros(1, struct_size)), 'coeffMu', num2cell(zeros(1, struct_size)), 'coeffRho', num2cell(zeros(1, struct_size)), 'coeffPsat', num2cell(zeros(1, struct_size)), 'coeffK', num2cell(zeros(1, struct_size)), 'coeffCl', num2cell(zeros(1, struct_size)), 'coeffHv', num2cell(zeros(1, struct_size)), 'coeffSigma', num2cell(zeros(1, struct_size)));
